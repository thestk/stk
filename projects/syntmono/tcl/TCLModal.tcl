...
radiobutton .radio2.4 -text Reso      -bg grey66 \
    -command {printWhatz "ControlChange    0.0 1 " 16 4} \
    -variable preset -value 4
radiobutton .radio2.5 -text Wood2 -bg grey66 \
    -command {printWhatz "ControlChange    0.0 1 " 16 5} \
    -variable preset -value 5
radiobutton .radio2.6 -text Beats -bg grey66 \
    -command {printWhatz "ControlChange    0.0 1 " 16 6} \
    -variable preset -value 6
radiobutton .radio2.7 -text 2Fix -bg grey66 \
    -command {printWhatz "ControlChange    0.0 1 " 16 7} \
    -variable preset -value 7
radiobutton .radio2.8 -text Clump -bg grey66 \
    -command {printWhatz "ControlChange    0.0 1 " 16 8}\
    -variable preset -value 8
...
-command {printWhatz "ControlChange    -1.0  1 " 99} \
